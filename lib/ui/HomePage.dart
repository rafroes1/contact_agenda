...
class _HomePageState extends State<HomePage> {
  ...
  void _showContactPage({Contact contact}) async {
    ...
    if (recContact != null) {
      //se retornou da outra pagina um contato
      if (contact != null) {
        //verifica se o contato ja existia
        await helper.updateContact(recContact); //se sim da update no contato
      } else {
        //se recebeu um contato mas o contato nao existia
        await helper.saveContact(recContact); //salva novo contato
      }
      _refreshAllContacts(); //atualiza lista de contatos
    }
  }
